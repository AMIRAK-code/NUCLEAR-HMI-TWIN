...
export const DAO = {
  ...
  _s: {
    CORE_TEMP:    { tag:'T-CORE-01',   label:'Core Temperature',       sys:'Primary',   u:'°C',          vlt:1.4,  v:1100, trip:1200, low:900,  source:'SIM' },
    COOLANT_IN:   { tag:'T-CL-IN-01',  label:'Coolant Inlet Temp',     sys:'Primary',   u:'K',           vlt:0.7,  v:580,  trip:620,  low:480,  source:'SIM' },
    COOLANT_OUT:  { tag:'T-CL-OUT-01', label:'Coolant Outlet Temp',    sys:'Primary',   u:'K',           vlt:0.8,  v:870,  trip:900,  low:750,  source:'SIM' },
    PRIM_PRESS:   { tag:'P-PRI-01',    label:'Primary Pressure ΔP',    sys:'Primary',   u:'PSI',         vlt:0.55, v:230,  trip:250,  low:150,  source:'SIM' },
    PUMP_A:       { tag:'N-PMP-A-01',  label:'Pump A Speed',           sys:'Primary',   u:'RPM',         vlt:5,    v:3400, trip:3600, low:2800, source:'SIM' },
    PUMP_B:       { tag:'N-PMP-B-01',  label:'Pump B Speed',           sys:'Secondary', u:'RPM',         vlt:5,    v:3400, trip:3600, low:2800, source:'SIM' },
    NEUTRON_FLUX: { tag:'F-NEUT-01',   label:'Neutron Flux',           sys:'Primary',   u:'e14 n/cm²·s', vlt:0.02, v:3.8,  trip:4.0,  low:2.5,  source:'SIM' },
    FUEL_BURNUP:  { tag:'B-FUEL-01',   label:'Fuel Burnup',            sys:'Primary',   u:'GWd/t',       vlt:0,    v:55,   trip:60,   low:0,    source:'SIM' },
    SG_INLET:     { tag:'T-SG-IN-01',  label:'SG Inlet Temperature',   sys:'Secondary', u:'°C',          vlt:0.65, v:510,  trip:550,  low:420,  source:'SIM' },
    STEAM_PRESS:  { tag:'P-STM-01',    label:'Steam Pressure',         sys:'Secondary', u:'bar',         vlt:0.28, v:172,  trip:180,  low:130,  source:'SIM' },
    TURBINE_RPM:  { tag:'N-TRB-01',    label:'Turbine Speed',          sys:'Secondary', u:'RPM',         vlt:3,    v:3150, trip:3200, low:2800, source:'SIM' },
    GRID_OUT:     { tag:'P-GRID-01',   label:'Grid Electrical Output', sys:'Grid',      u:'MWe',         vlt:0.4,  v:500,  trip:510,  low:400,  source:'SIM' },
    ROD_POS:      { tag:'R-ROD-AVG',   label:'Control Rod Pos (avg)',  sys:'Safety',    u:'%',           vlt:0.08, v:90,   trip:95,   low:5,    source:'SIM' },
    SCRAM_V:      { tag:'V-SCR-01',    label:'SCRAM Bus Voltage',      sys:'Safety',    u:'V',           vlt:0.04, v:110,  trip:150,  low:40,   source:'SIM' },
    LEAD_LEVEL:   { tag:'L-PB-01',     label:'Lead Coolant Level',     sys:'Primary',   u:'%',           vlt:0.04, v:95,   trip:100,  low:88,   source:'SIM' },
    SEC_FLOW:     { tag:'F-SEC-01',    label:'Secondary Flow Rate',    sys:'Secondary', u:'kg/s',        vlt:3.5,  v:3000, trip:3200, low:2400, source:'SIM' },
  },
